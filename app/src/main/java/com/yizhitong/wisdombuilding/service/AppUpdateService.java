package com.yizhitong.wisdombuilding.service;
...
import com.yizhitong.wisdombuilding.BuildConfig;
...
public class AppUpdateService extends Service {
     ...
     * 保存的路径
     */
    private String mSavePath = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "yizhutong.apk";
    /**
     * 下载的Url
     */
